...
def load_datasets(splits):
    ...
    for split in splits:
        ...
        # load json
        if split in ['train', 'val_train_seen', 'val_seen', 'val_unseen', 'test']:
...
def ndtw_graphload(scan):
    ...
    Ref: https://www.aclweb.org/anthology/P19-1181/
    Code: https://github.com/google-research/google-research/tree/master/r4r
    """
