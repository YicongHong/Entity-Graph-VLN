...
class R2RBatch():
    ...
    def __init__(self, feature_store, pano_caffe=None, batch_size=100, seed=10, splits=['train'], tokenizer=None,
                 name=None):
    ...
    def _get_obs(self):
        ...
        for i, (feature, state) in enumerate(self.env.getStates()):
            ...
            if args.test_obj:
                ...
                cand_obj_list = self.object_feats(self.pano_caffe, candidate, top_N_obj, state.location.viewpointId)
