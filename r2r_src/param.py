...
class Param:
    def __init__(self):
        ...
        self.parser.add_argument("--load", default=None) # snap/agent_id/state_dict/best_val_unseen
...
param = Param()
args = param.args
args.TRAIN_VOCAB = 'data/train_vocab.txt'
args.TRAINVAL_VOCAB = 'data/trainval_vocab.txt'
